 ...
 */
public class OaMapUtils extends HashMap<String, Object> {
    ...
    /**
     * 根据companyId + UserId + checkinTime + taskInstanceId 进行分组
     * @param
     * @return
     */
    public static String fetchKey(String companyId ,String userId , String time , String taskInstanceId ){
        return companyId+"&"+userId+"&"+time+"&"+taskInstanceId;
    }
}
